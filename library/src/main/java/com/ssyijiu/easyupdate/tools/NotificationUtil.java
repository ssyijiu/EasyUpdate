...
public class NotificationUtil {
    ...
    public static Notification easyNotification(NotificationCompat.Builder builder, int notificationIconResId, String notificationTitle, String notificationContent, boolean isCanClear) {
    ...
    public static void show(Notification notification) {
        NotificationManager manager = (NotificationManager) EasyUpdate.context().getSystemService(
